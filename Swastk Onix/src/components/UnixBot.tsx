...
export function UnixBot({ isOpen, setIsOpen, initialMessage }: { isOpen: boolean; setIsOpen: (open: boolean) => void; initialMessage?: string }) {
  ...
  // Handle initial message from service tags
  useEffect(() => {
